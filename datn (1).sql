...
-- Thời gian đã tạo: Th12 11, 2024 lúc 12:54 PM
...
(90, 1, 1, 'Minh Sang', '– Mã sp: RB-769S 12 tính năng– Vật liệu Cối: Thủy tinh chịu lực, chịu nhiệt cao– Dung tích Cối: 1,75 lít– Tổng công suất: 1500W; công suất nấu 800W; công suất xay 700W– Điện áp 220V-50Hz– Tốc độ vòng quay: 48.000 vòng/phút– Kích thước: 232x200', 2, 12412, 'http://localhost:3000/uploads/Image-1732627296879.webp', 7, 1),
(91, 1, 1, 'Minh Sang91', '– Mã sp: RB-769S 12 tính năng– Vật liệu Cối: Thủy tinh chịu lực, chịu nhiệt cao– Dung tích Cối: 1,75 lít– Tổng công suất: 1500W; công suất nấu 800W; công suất xay 700W– Điện áp 220V-50Hz– Tốc độ vòng quay: 48.000 vòng/phút– Kích thước: 232x200', 91, 91, 'http://localhost:3000/uploads/Image-1732632761133.jpg', 7, 1),
...
(102, 1, 1, 'Minh Sang', 'Máy giặt việt nam chất lượng cao', 4, 234234, 'http://localhost:3000/uploads/Image-1732626352657.jpg', 9, 1),
(103, 1, 1, 'Minh Sang', 'Máy giặt việt nam chất lượng cao', 9, 8, 'http://localhost:3000/uploads/Image-1732627514022.jpg', 8, 1),
(105, 2, 1, 'Minh Sang105', 'Máy giặt việt nam chất lượng cao', 105, 10, 'http://localhost:3000/uploads/Image-1732634604378.jpg', 9, 1),
(106, 1, 1, 'Minh Sang106', 'Mã sản phẩm	Sunhouse SHB9105Hãng	SHB9105Loại sản phẩm	Bếp từSố bếp nấu	2 bếpMặt kính	Mặt kính chịu nhiệtBảng điều khiển	Cảm ứngChế độ hẹn giờ độc lập cho từng bếp, báo động bằng âm thanh	CóKhóa an toàn trẻ em Child lock	CóCông suất tổng	43', 2, 4, 'http://localhost:3000/uploads/Image-1732635672010.jpg', 9, 1);
...
(195, 91, 'http://localhost:3000/uploads/additionalImages-1732633194168.jpg'),
(196, 91, 'http://localhost:3000/uploads/additionalImages-1732633194171.webp'),
(214, 105, 'http://localhost:3000/uploads/additionalImages-1732634427051.webp'),
(215, 105, 'http://localhost:3000/uploads/additionalImages-1732634604382.jpg'),
(216, 105, 'http://localhost:3000/uploads/additionalImages-1732634604383.jpg'),
(218, 106, 'http://localhost:3000/uploads/additionalImages-1732635612321.jpg'),
(219, 106, 'http://localhost:3000/uploads/additionalImages-1732635612326.webp'),
(220, 106, 'http://localhost:3000/uploads/additionalImages-1732635659710.jpg'),
(221, 106, 'http://localhost:3000/uploads/additionalImages-1732635659710.jpg'),
(222, 1, 'http://localhost:3000/uploads/additionalImages-1732675503061.jpg');
...
(1, 39, 42, '2024-12-11 12:10:06'),
(2, 39, 17, '2024-12-11 12:10:06'),
(3, 38, 14, '2024-12-11 12:11:06');
...
--
ALTER TABLE `products`
  MODIFY `Product_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;

--
-- AUTO_INCREMENT cho bảng `product_images`
--
ALTER TABLE `product_images`
  MODIFY `Image_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=223;
...
--
ALTER TABLE `vouchers`
  MODIFY `Voucher_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
